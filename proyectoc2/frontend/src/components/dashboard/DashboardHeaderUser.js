                    ...
                    <div className="first-row">
                        ...
                        <div className="user">
                            <div className="user-avatar">
                                <img class="user-avatar-image" src="https://s3.amazonaws.com/brainscape-prod/system/um/004/484/913/avatar_square.?1569038897" />
                            </div>

                            <h3 className="user-name">{user ? `${user.name} ${user.lastname}` : ''}</h3>
                            <div class="user-stats">(53 Cards studied • 1 Decks created)</div>
                        </div>
